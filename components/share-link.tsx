  ...
  <>
   <div className={cn("flex items-center gap-2", className)}>
    <input
     ...
     className="h-9 min-w-0 flex-1 rounded-md  border border-border border-input bg-background px-3 font-mono text-xs text-muted-foreground outline-none focus:ring-2 focus:ring-ring"
    />
    <Button
     type="button"
     size="sm"
...
function QrDialog({
 ...
 return (
  ...
  >
   <div
    className="w-full max-w-sm rounded-md  border border-border bg-card shadow-xl"
   ...
   >
    ...
    <div className="flex flex-col items-center gap-4 p-6">
     <div className="flex aspect-square w-full max-w-[256px] items-center justify-center rounded-md  border border-border bg-white p-4">
      {error ? (
