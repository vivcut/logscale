   ...
   <div className="grid w-full grid-cols-1 sm:grid-cols-3 gap-3">
    {features.map((item) => {
     ...
     return (
      <div
       key={item.id}
       className="flex items-center justify-center gap-2.5 py-3 rounded-xl bg- border-2 border-border not-dark:!bg-black/5 transition-colors hover:border-white/20"
      >
       <IconComponent
        size={24}
        className={`shrink-0`}
