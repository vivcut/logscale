...
function HistoryBar({
 ...
 return (
  <div className="group/bar relative flex-1">
   ...
   />
   {/* Tooltip */}
   <div className="pointer-events-none absolute bottom-full left-1/2 z-30 mb-2 hidden -translate-x-1/2 whitespace-nowrap rounded-xl  border-2 border-border bg-popover px-2.5 py-1.5 text-left shadow-xl group-hover/bar:block">
       ...
       {entry.kind === "auto" ? (
        ...
        <div>
         <div className="flex flex-wrap items-center gap-1.5">
          <span
           className={cn(
            "inline-flex items-center rounded-full  border-2 border-border px-1.5 py-0.5 font-mono text-[9px] font-medium uppercase tracking-wide",
...
function SiteRow({
 ...
 return (
  <div className="border-b-2 px-4 py-4 last:border-b-0">
   <div className="flex items-start justify-between gap-3">
    <div className="min-w-0">
     <div className="flex items-center gap-2">
      ...
      <span
       className={cn(
        "inline-flex shrink-0 items-center gap-1.5 rounded-full  border-2 border-border px-2 py-0.5 font-mono text-[10px] font-medium",
        meta.pill
       )}
      >
       <span className={cn("size-1.5 rounded-full", meta.dot)} />
...
export function StatusBoard({
 ...
 if (sites.length === 0) {
  return (
   <div className="rounded-xl  border-2 border-border border-dashed px-4 py-12 text-center text-sm text-muted-foreground">
