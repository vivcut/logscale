    ...
    <ol className="relative border-l border-border">
      {entries.map((entry) => (
        <li key={entry.id} className="relative pb-14 pl-8 last:pb-0">
          ...
          <span className="absolute -left-[5px] top-1.5 size-2.5 rounded-full border-2 border-border-2 bg-background ring-4 ring-background" />
          ...
          <article className="rounded-xl border-2 border-border-2 bg-card p-6">
