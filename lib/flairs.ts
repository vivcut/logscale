 ...
 * "feedback", "bug"). Every board is seeded with the two base flairs below and
 * owners can add more. This module centralises the defaults + badge styling so
 * the public board, post detail and dashboard stay visually consistent.
 */
export const BASE_FLAIRS = ["feedback", "bug"] as const;

/**
 * Deterministic colour palette for flair chips. The two base flairs get fixed
