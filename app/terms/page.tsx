...
export const metadata: Metadata = {
  title: "Terms of Service — ToTheMoon",
  description:
    "The terms and conditions for using the ToTheMoon feedback platform.",
};
...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: (
      <p>
        By creating an account or using ToTheMoon, you agree to these Terms of
  ...
  },
  {
    ...
    body: (
      <>
        <p>You agree not to use ToTheMoon to:</p>
        <ul>
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          ToTheMoon offers a free <strong>Hobby</strong> plan and a paid{" "}
  ...
  },
  {
    ...
    body: (
      <p>
        We work hard to keep ToTheMoon fast and reliable, but the service is
  ...
  },
  {
    ...
    body: (
      <p>
        To the maximum extent permitted by law, ToTheMoon and its team will not
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro={
        <p>
          These Terms of Service govern your use of ToTheMoon. Please read them
