...
export const metadata: Metadata = {
  title: "Terms of Service — Pittstop",
  description:
    "The terms and conditions for using the Pittstop feedback platform.",
};
...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: (
      <p>
        By creating an account or using Pittstop, you agree to these Terms of
  ...
  },
  {
    ...
    body: (
      <>
        <p>You agree not to use Pittstop to:</p>
        <ul>
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Pittstop offers a free <strong>Hobby</strong> plan and a paid{" "}
  ...
  },
  {
    ...
    body: (
      <p>
        We work hard to keep Pittstop fast and reliable, but the service is
  ...
  },
  {
    ...
    body: (
      <p>
        To the maximum extent permitted by law, Pittstop and its team will not
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro={
        <p>
          These Terms of Service govern your use of Pittstop. Please read them
