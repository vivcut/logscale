    ...
    <div className="mb-3 flex flex-wrap items-center gap-1.5">
     {FILTERS.map((f) => (
      <button
       ...
       className={cn(
        "rounded-full  border-2 border-border px-3 py-1 font-mono text-[11px] transition-colors",
        filter === f.key
      ...
      {sortedPosts.map((post) => (
       ...
       >
        <button
         ...
         className={cn(
          "flex h-fit w-12 shrink-0 flex-col items-center gap-0.5 rounded-xl  border-2 border-border py-2 transition-colors",
          voted[post.id]
