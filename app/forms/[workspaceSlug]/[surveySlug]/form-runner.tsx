...
export function FormRunner({
  ...
  if (state.ok) {
    return (
      <div className="flex flex-col items-center justify-center rounded-md  border border-border  bg-card py-16 text-center">
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      {/* Email field */}
      <div className="space-y-2 rounded-md  border border-border  bg-card p-5">
