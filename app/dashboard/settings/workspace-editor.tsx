...
export function WorkspaceEditor({
  ...
  return (
    <>
      <div className="grid gap-px overflow-hidden rounded-xl border-2 border-border-2 bg-border-2 sm:grid-cols-2">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onCancel}
      />
      <div className="relative w-full max-w-md overflow-hidden rounded-xl border-2 border-border-2 bg-popover shadow-2xl">
        <div className="flex items-start gap-3 p-5">
          <div className="flex size-9 shrink-0 items-center justify-center rounded-xl border-2 border-border-2 bg-secondary">
        ...
        <div className="flex justify-end gap-2 border-t-2 border-border-2 bg-card/50 px-5 py-3">
