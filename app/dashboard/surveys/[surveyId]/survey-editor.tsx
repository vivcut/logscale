...
export function SurveyEditor({
  ...
  return (
    <div className="space-y-6">
      {/* Publish bar */}
      <div className="flex flex-col gap-3 rounded-xl  border-2 border-border  bg-card p-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <form action={saveAction} className="space-y-6">
        ...
        <div className="space-y-4 rounded-xl  border-2 border-border  bg-card p-5">
          ...
          <label className="flex cursor-pointer items-center justify-between rounded-xl  border-2 border-border  bg-background px-3.5 py-3">
        ...
        <div className="space-y-3">
          {items.length === 0 ? (
            <div className="rounded-xl  border-2 border-border border-dashed  py-10 text-center">
          ...
          <div className="flex flex-wrap items-center gap-2 rounded-xl  border-2 border-border border-dashed  p-3">
            ...
            {(Object.keys(QUESTION_TYPE_LABELS) as QuestionType[]).map((t) => {
              ...
              return (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl  border-2 border-border  px-2.5 py-1.5 font-mono text-xs text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
                >
                  <Icon className="size-3.5" />
