  ...
  <div className="mx-auto w-full max-w-4xl px-6 py-10">
   ...
   <div className="mb-8 flex items-start justify-between gap-4">
    <div className="flex items-center gap-3">
     <div className="flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-xl  border-2 border-border bg-secondary text-sm font-medium">
      {workspace.logo_url ? (
   ...
   {/* Create */}
   <div className="mb-8 rounded-xl  border-2 border-border bg-card p-4">
