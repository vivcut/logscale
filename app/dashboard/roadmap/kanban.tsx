    ...
    <div className="rounded-xl  border-2 border-border  bg-card p-3">
      ...
      <div className="relative mt-3">
        <button
          onClick={() => setOpen((v) => !v)}
          disabled={pending}
          className="flex w-full items-center justify-between rounded-xl  border-2 border-border  px-2.5 py-1.5 text-left font-mono text-xs text-muted-foreground transition-colors hover:border-foreground/30 hover:text-foreground"
        >
          {pending ? (
