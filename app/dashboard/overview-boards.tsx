    ...
    <div className="mt-8">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-xl border-2 border-border-2 bg-secondary/40 px-2.5 py-1 font-mono text-[11px] tabular-nums text-muted-foreground">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border-2 border-border-2 bg-secondary/40 px-2.5 py-1 text-xs transition-colors hover:bg-secondary"
            >
            ...
            {menuOpen ? (
              <>
                ...
                />
                <div className="absolute right-0 top-full z-20 mt-1 w-48 overflow-hidden rounded-xl border-2 border-border-2 bg-popover p-1 shadow-xl">
                  <button
                    onClick={() => {
                      setActiveId("all");
                      setMenuOpen(false);
      ...
      {visible.length === 0 ? (
        <div className="rounded-xl border-2 border-dashed border-border-2 px-4 py-10 text-center font-mono text-xs text-muted-foreground">
        ...
        <ul className="divide-y divide-border-2 overflow-hidden rounded-xl border-2 border-border">
          {visible.map((p) => {
            ...
            return (
              ...
              >
                {/* votes */}
                <div className="flex h-fit w-12 shrink-0 flex-col items-center gap-0.5 rounded-xl border-2 border-border-2 py-2 text-muted-foreground">
  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-1.5 rounded-xl border-2 border-border-2 bg-secondary/40 px-2.5 py-1 font-mono text-[11px] transition-colors hover:bg-secondary"
      >
        {current.label}
        <ChevronDown className="size-3 text-muted-foreground" />
      </button>
